            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('dashboard') }}" wire:navigate
                        class="{{ request()->is('dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }} flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('posts') }}" wire:navigate
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Posts</a>
                        </li>
                        <li>
                            <a href="{{ route('posts') }}" wire:navigate
